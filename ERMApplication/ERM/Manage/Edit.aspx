<%@ Page Title="" Language="C#" MasterPageFile="~/ERM/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="ERMApplication.ERM.Manage.Edit" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <h2>Edit Symposium Registration</h2>
    <br />
    ...
    <p>
        <asp:Button ID="buttonUpdate" CssClass="btn btn-primary" runat="server" Text="Update" OnClick="buttonUpdate_Click" />
